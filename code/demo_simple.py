...
def main():
    ...
    user_prompt = "Design a 64 to 1 MUX with pipelined architecture and low latency."
...
def main():
    ...
    user_prompt = "Define a 64 to 1 multiplexer with low latency with hierarchical structure."
    ppa_goal = {"freq_mhz": 250, "optimize_for": ["latency"]}

    # 2) Build system prompt
    sys_prompt_path = build_system_prompt_simple(user_prompt, ppa_goal)
